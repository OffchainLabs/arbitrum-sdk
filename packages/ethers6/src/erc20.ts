/**
 * ERC-20 bridger functions for ethers v6 users.
 *
 ...
 * Accepts ethers v6 Providers for both parent and child chains.
 */
export async function getErc20DepositRequest(
  ...
  return coreGetErc20DepositRequest({
    ...params,
    parentProvider: wrapProvider(params.parentProvider),
    childProvider: wrapProvider(params.childProvider),
  })
}
