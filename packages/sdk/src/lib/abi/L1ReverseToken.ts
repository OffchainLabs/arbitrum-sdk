...
export interface L1ReverseTokenInterface extends utils.Interface {
  contractName: "L1ReverseToken";
  functions: {
...
export interface L1ReverseToken extends BaseContract {
  contractName: "L1ReverseToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1ReverseTokenInterface;
