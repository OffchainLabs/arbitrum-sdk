...
export interface L1OrbitReverseCustomGateway extends BaseContract {
  ...
  functions: {
    ...
    "forceRegisterTokenToL2(address[],address[],uint256,uint256,uint256,uint256)"(
      _l1Addresses: string[],
      _l2Addresses: string[],
    ...
    "registerTokenToL2(address,uint256,uint256,uint256,address,uint256)"(
      _l2Address: string,
      _maxGas: BigNumberish,
      _gasPriceBid: BigNumberish,
      _maxSubmissionCost: BigNumberish,
    ...
    "registerTokenToL2(address,uint256,uint256,uint256,uint256)"(
      _l2Address: string,
      _maxGas: BigNumberish,
      _gasPriceBid: BigNumberish,
      _maxSubmissionCost: BigNumberish,
