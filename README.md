...
> **Note**: The master brancha in this repository points to a legacy 1.x.x version of the SDK. The current recommended version of the package is ^2.0.9 which can be found on the c-nitro-migration branch. This migration version will work both pre and post the nitro upgrade, and is available to download via npm.
