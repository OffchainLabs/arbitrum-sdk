...
export interface AbsBridgeCreatorInterface extends utils.Interface {
...
export interface AbsBridgeCreator extends BaseContract {
  contractName: "AbsBridgeCreator";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AbsBridgeCreatorInterface;
