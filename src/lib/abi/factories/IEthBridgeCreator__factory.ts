...
import type {
  IEthBridgeCreator,
  IEthBridgeCreatorInterface,
} from "../IEthBridgeCreator";
...
export class IEthBridgeCreator__factory {
  static readonly abi = _abi;
  static createInterface(): IEthBridgeCreatorInterface {
    return new utils.Interface(_abi) as IEthBridgeCreatorInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IEthBridgeCreator {
    return new Contract(address, _abi, signerOrProvider) as IEthBridgeCreator;
  }
}
