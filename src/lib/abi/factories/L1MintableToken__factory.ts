...
import type {
  L1MintableToken,
  L1MintableTokenInterface,
} from "../L1MintableToken";
...
export class L1MintableToken__factory {
  static readonly abi = _abi;
  static createInterface(): L1MintableTokenInterface {
    return new utils.Interface(_abi) as L1MintableTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): L1MintableToken {
    return new Contract(address, _abi, signerOrProvider) as L1MintableToken;
  }
}
