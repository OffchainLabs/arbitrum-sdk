...
export interface L1MintableTokenInterface extends utils.Interface {
  contractName: "L1MintableToken";
  functions: {
...
export interface L1MintableToken extends BaseContract {
  contractName: "L1MintableToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1MintableTokenInterface;
