...
export interface ERC20BridgeCreatorInterface extends utils.Interface {
  contractName: "ERC20BridgeCreator";
  functions: {
...
export interface ERC20BridgeCreator extends BaseContract {
  contractName: "ERC20BridgeCreator";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20BridgeCreatorInterface;
