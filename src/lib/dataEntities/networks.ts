...
/**
 * The token bridge data format generated by Nitro.
 */
export interface NitroTokenBridge {
...
const isNitroTokenBridge = (
  tokenBridge: any
): tokenBridge is NitroTokenBridge => {
  return (
    tokenBridge &&
    typeof tokenBridge === 'object' &&
    'l1GatewayRouter' in tokenBridge &&
    'l2GatewayRouter' in tokenBridge &&
    'l1ERC20Gateway' in tokenBridge &&
    'l2ERC20Gateway' in tokenBridge
  )
}
 ...
 */
export function migrateToParentChildTokenBridge(
  input: NitroTokenBridge | TokenBridge | undefined
): TokenBridge | undefined {
  if (input) {
    if (isNitroTokenBridge(input)) {
      return {
...
export function mapL2NetworkToArbitrumNetwork(
  ...
  return {
    ...
    tokenBridge: migrateToParentChildTokenBridge(l2Network.tokenBridge),
  }
}
